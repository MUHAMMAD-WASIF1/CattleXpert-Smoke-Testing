...
describe("LOGIN TO CATTLEXPERT WEBSITE", () => {
  ...
  it("Generating and Verifying the By Pen Report ", () => {
    login_headstrom();
    ...
    cy.get(
      "#ctl00_ctl00_ContentPlaceHolder_RightSectionPlaceHolder_ReportViewer1_ctl04_ctl04 select"
    ).select("2");
