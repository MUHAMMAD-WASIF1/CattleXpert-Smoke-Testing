...
describe('should navigate to Carrier profile successfully', () => {
  beforeEach(() => {
    cy.visit('/Login.aspx');
    ...
    cy.get('#Item_COR127').click();
  });

  it('Create a Carrier profile', () => {
    ...
    const email = `Carrier${Math.floor(Math.random() * 1000000)}@test.com`;
    ...
    // Save the Carreir Profile
    cy.get('#btnSaveCarreir').click();
